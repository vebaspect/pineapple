...
INSERT INTO
    public."Users"("Id", "Type", "FullName", "Login", "Phone", "Email", "CreationDate", "ModificationDate", "IsDeleted")
	VALUES ('00000000-0000-0000-0000-000000000000', 'Administrator', 'Administrator', 'admin', NULL, NULL, NOW(), NOW(), false);

-- Typy komponentów:

INSERT INTO
    public."ComponentTypes"("Id", "Name", "Symbol", "Description", "CreationDate", "ModificationDate", "IsDeleted")
...
INSERT INTO
    public."OperatingSystems"("Id", "Name", "Symbol", "Description", "CreationDate", "ModificationDate", "IsDeleted")
...
INSERT INTO
    public."SoftwareApplications"("Id", "Name", "Symbol", "Description", "CreationDate", "ModificationDate", "IsDeleted")
